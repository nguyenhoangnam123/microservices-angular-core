...
import { UserRolesComponent } from 'app/entities/UserManagement/user-roles/user-roles.component';
...
describe('Component Tests', () => {
  describe('UserRoles Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userRoles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
