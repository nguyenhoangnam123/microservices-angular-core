...
export class UserRolesComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-user-roles div table .btn-danger'));
  title = element.all(by.css('jhi-user-roles div h2#page-heading span')).first();
...
export class UserRolesUpdatePage {
  pageTitle = element(by.id('jhi-user-roles-heading'));
...
export class UserRolesDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-userRoles-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-userRoles'));
