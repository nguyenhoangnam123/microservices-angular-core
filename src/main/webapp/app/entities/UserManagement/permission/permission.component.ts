...
export class PermissionComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.permissionService
      ...
      .subscribe((res: HttpResponse<IPermission[]>) => this.paginatePermissions(res.body, res.headers));
  }
  ...
  protected paginatePermissions(data: IPermission[], headers: HttpHeaders) {
