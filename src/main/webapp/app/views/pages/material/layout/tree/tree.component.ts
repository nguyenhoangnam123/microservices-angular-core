...
export class DynamicDataSource {
  ...
  constructor(private treeControl: FlatTreeControl<DynamicFlatNode>, private database: DynamicDatabase, private cdr: ChangeDetectorRef) {}
...
export class TreeComponent implements OnInit {
  ...
  constructor(
    ...
    this.treeFlattener2 = new MatTreeFlattener(this.transformer2, this._getLevel2, this._isExpandable2, this._getChildren2);
    ...
    this.treeFlattener3 = new MatTreeFlattener(this.transformer3, this.getLevel3, this.isExpandable3, this.getChildren3);
    ...
    this.treeFlattener4 = new MatTreeFlattener(this.transformer4, this.getLevel4, this.isExpandable4, this.getChildren4);
