...
public class AuthResource {
     ...
     *
     * @param request  the {@link HttpServletRequest} holding - among others - the
     *                 headers passed from the client.
     * @param response the {@link HttpServletResponse} getting the cookies set upon
     *                 successful authentication.
     * @param params   the login params (username, password, rememberMe).
     * @return the access token of the authenticated user. Will return an error code
     *         if it fails to authenticate the user.
     */
