...
public interface OAuth2TokenEndpointClient {
     ...
     * @return the access token and enclosed refresh token received from the token
     *         endpoint.
     * @throws org.springframework.security.oauth2.common.exceptions.ClientAuthenticationException if
     *                                                                                             we
     *                                                                                             cannot
     *                                                                                             contact
     *                                                                                             the
